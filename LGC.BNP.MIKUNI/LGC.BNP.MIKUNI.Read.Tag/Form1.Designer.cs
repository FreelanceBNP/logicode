namespace LGC.BNP.MIKUNI.Read.Tag
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.status_reader.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			...
			this.status_segnalr.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			...
			this.status_segnalr.Visible = false;
			// 
			// btn_con_signalr
			// 
			...
			this.btn_con_signalr.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			this.btn_con_signalr.Name = "btn_con_signalr";
			this.btn_con_signalr.Size = new System.Drawing.Size(25, 25);
			this.btn_con_signalr.TabIndex = 6;
			this.btn_con_signalr.UseVisualStyleBackColor = false;
			this.btn_con_signalr.Visible = false;
