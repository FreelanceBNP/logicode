...
namespace LGC.BNP.MIKUNI.Web.Controllers
{
    ...
    public class ReportController : BaseController
    {
		...
		public ReportController(IConfiguration config, AccountService account, UtilityService util, TransactionService transaction, MasterService master) : base(account, util)
		{
			_config = config;
			_account = account;
			_utility = util;
		...
		public IActionResult ReportActionLog()
		{
			ViewBag.title = "Report Log";
			return View();
		}
		public IActionResult ReportTagLocation()
		{
			ViewBag.title = "Report Tag Location";
			return View();
		}
        public IActionResult ReportAllowItem()
        {
			ViewBag.title = "Report Allow Item";
			return View();
		}
		[AllowAnonymous]
